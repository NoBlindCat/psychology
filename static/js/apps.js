...
var handleSidebarMinify = function() {
    $('[data-click=sidebar-minify],#header-navbar>i').click(function(e) {
        e.preventDefault();
        var sidebarClass = 'page-sidebar-minified';
        var targetContainer = '#page-container';
        var clentWidth = document.body.clientWidth || document.documentElement.clientWidth;
        var headerWidth = Number(clentWidth - 260);
        var headerMinWidth = Number(clentWidth - 100);
        $('#sidebar [data-scrollbar="true"]').css('margin-top','0');
        $('#sidebar [data-scrollbar="true"]').removeAttr('data-init');
        $('#sidebar [data-scrollbar=true]').stop();
        if ($(targetContainer).hasClass(sidebarClass)) {
            $('#content-right').css('margin-left','220px');
            if("undefined" != typeof window.flowsChart  || "undefined" != typeof window.uaChart || "undefined" != typeof window.sourcesChart || "undefined" != typeof window.codesChart || "undefined" != typeof window.areasChart){
                $('.flows-tabs-header li.active').click();
                // window.flowsChart.default(btnDefaults);
            }
            if("undefined" != typeof window.accessChart){
                window.accessChart.default(0);
            }
            if("undefined" != typeof window.indexChart){
                window.indexChart.default();
            }
            $('#header-navbar').children('i').removeClass('fa-indent').addClass('fa-outdent');
            $(targetContainer).removeClass(sidebarClass);
            ...
            $(targetContainer).addClass(sidebarClass);
            $('#content-right').css('margin-left', '60px');
            // 判断是否存在js
            if("undefined" != typeof window.flowsChart || "undefined" != typeof window.uaChart || "undefined" != typeof window.sourcesChart || "undefined" != typeof window.codesChart || "undefined" != typeof window.areasChart){
                $('.flows-tabs-header li.active').click();
                // window.flowsChart.default(btnDefaults);
            ...
            $('#header-navbar').children('i').removeClass('fa-outdent').addClass('fa-indent');
            if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                if ($(targetContainer).hasClass('page-sidebar-fixed')) {
                    $('#sidebar [data-scrollbar="true"]').slimScroll({destroy: true});
                    $('#sidebar [data-scrollbar="true"]').removeAttr('style');
...
var handleThemePageStructureControl = function() {
    ...
    $('.theme-list [data-theme]').click(function() {
        ...
        $.cookie('theme', $(this).attr('data-theme'), { path: '/' });
...
// 全局Loading
var handlePageLoadings = function(){
    // alert()
    // console.log(3333)
